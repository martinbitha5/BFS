...
api.interceptors.request.use((config) => {
  ...
  const userData = localStorage.getItem('bfs_support_user');
  ...
  if (userData && !isAuthRoute) {
    try {
      ...
      // Support a accès à tous les aéroports
