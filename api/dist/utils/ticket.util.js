...
exports.extractTicketNumberWithoutCompanyCode = extractTicketNumberWithoutCompanyCode;
exports.extractFlightDateFromRawData = extractFlightDateFromRawData;
exports.formatFlightDate = formatFlightDate;
exports.extractCabinClass = extractCabinClass;
exports.formatCabinClass = formatCabinClass;
/**
 ...
 */
function extractTicketNumberWithoutCompanyCode(ticketNumber, companyCode) {
    if (!ticketNumber) {
        return undefined;
    }
...
function extractFlightDateFromRawData(rawData) {
    ...
    for (const match of sortedMatches) {
        ...
        if (day >= 1 && day <= 31 && validMonths.includes(month) && !knownAirports.includes(month)) {
            ...
            const isSurroundedByAirports = knownAirports.some(apt => (before.includes(apt) && after.match(/^\d/)) || // Avant aéroport + chiffres après
 ...
 */
function convertJulianDayToDate(julianDay) {
 ...
 */
function extractCabinClass(rawData, seatNumber) {
