...
exports.normalizeAuthError = normalizeAuthError;
exports.normalizeHttpAuthError = normalizeHttpAuthError;
/**
 ...
 */
function normalizeAuthError(errorMessage, context = 'general') {
    ...
    if (context === 'login') {
        ...
        if (lowerMessage.includes('user is disabled') ||
 ...
 */
function normalizeHttpAuthError(statusCode, context = 'general') {
    switch (statusCode) {
        case 400:
