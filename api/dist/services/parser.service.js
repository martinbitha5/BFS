...
exports.parserService = exports.isKnownAirline = exports.getAirlineName = exports.KNOWN_AIRPORT_CODES = exports.KNOWN_AIRLINES = void 0;
const airlines_1 = require("../constants/airlines");
Object.defineProperty(exports, "KNOWN_AIRLINES", { enumerable: true, get: function () { return airlines_1.KNOWN_AIRLINES; } });
Object.defineProperty(exports, "getAirlineName", { enumerable: true, get: function () { return airlines_1.getAirlineName; } });
Object.defineProperty(exports, "isKnownAirline", { enumerable: true, get: function () { return airlines_1.isKnownAirline; } });
const airport_codes_1 = require("../constants/airport-codes");
Object.defineProperty(exports, "KNOWN_AIRPORT_CODES", { enumerable: true, get: function () { return airport_codes_1.KNOWN_AIRPORT_CODES; } });
const ticket_util_1 = require("../utils/ticket.util");
const pnr_extractor_service_1 = require("./pnr-extractor.service");
/**
 ...
 */
function convertJulianDayToDate(julianDay, year) {
 ...
 */
function convertJulianDayToDisplayFormat(julianDay, year) {
    if (!julianDay || julianDay < 1 || julianDay > 366) {
        return undefined;
    }
...
class ParserService {
    ...
    parseEthiopian(rawData) {
        ...
        const pnr = pnr_extractor_service_1.pnrExtractorService.extractPnr(rawData);
        ...
        const flightDate = (0, ticket_util_1.extractFlightDateFromRawData)(rawData);
        // 7. Siège
        const seatNumber = this.extractSeatNumber(rawData);
        // 8. Numéro de ticket
        const ticketNumber = this.extractTicketNumber(rawData);
    ...
    parseGeneric(rawData) {
        ...
        if (bcbpMatch) {
            ...
            flightDate = (0, ticket_util_1.extractFlightDateFromRawData)(rawData);
        ...
        let airline;
        if (companyCode) {
            airline = (0, airlines_1.getAirlineName)(companyCode);
     ...
     */
    extractNameEthiopian(rawData, pnrFromParser) {
        ...
        for (const match of patternWithPnrMatches) {
            ...
            const airportPattern = airport_codes_1.KNOWN_AIRPORT_CODES.join('|');
        ...
        const pnr = pnrFromParser || pnr_extractor_service_1.pnrExtractorService.extractPnr(rawData);
        ...
        let volMatch = rawData.match(/ET\s*\d{2,4}/);
        if (volMatch) {
        ...
        if (volMatch) {
            ...
            if (volIndex > 2) {
                ...
                if (pnrPatternMatch) {
                    ...
                    if (airport_codes_1.KNOWN_AIRPORT_CODES.some(apt => afterPnr.includes(apt))) {
    ...
    extractPnrEthiopian(rawData) {
        ...
        const knownAirports = airport_codes_1.KNOWN_AIRPORT_CODES;
        ...
        const airportCodes = airport_codes_1.KNOWN_AIRPORT_CODES;
        const validMatches = [];
        ...
        if (validMatches.length > 0) {
            ...
            validMatches.sort((a, b) => {
                if (a.airportCode === 'FIH' && b.airportCode !== 'FIH')
                    return -1;
                if (b.airportCode === 'FIH' && a.airportCode !== 'FIH')
                    return 1;
     ...
     */
    extractFlightNumberEthiopian(rawData) {
     ...
     */
    extractBaggageInfoEthiopian(rawData) {
     ...
     */
    extractBaggageInfoAirCongo(rawData) {
     ...
     */
    parseEthiopianManifestLine(line) {
     ...
     * Extrait uniquement: Bag ID, Pax Surname, PNR, Route (origine/destination)
     */
    parseEthiopianManifest(manifestText) {
