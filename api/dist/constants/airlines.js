...
exports.AIRLINE_CODES = exports.KNOWN_AIRLINES = void 0;
exports.getAirlineName = getAirlineName;
exports.isKnownAirline = isKnownAirline;
exports.getAirlineDestinations = getAirlineDestinations;
exports.KNOWN_AIRLINES = [
...
function getAirlineName(code) {
    const airline = exports.KNOWN_AIRLINES.find(a => a.code === code);
    return airline ? airline.name : code;
}
/**
 * Vérifie si un code IATA est une compagnie connue
 */
function isKnownAirline(code) {
    return exports.KNOWN_AIRLINES.some(a => a.code === code);
}
/**
 * Récupère les destinations d'une compagnie
 */
function getAirlineDestinations(code) {
    const airline = exports.KNOWN_AIRLINES.find(a => a.code === code);
 ...
 */
exports.AIRLINE_CODES = exports.KNOWN_AIRLINES.map(a => a.code);
