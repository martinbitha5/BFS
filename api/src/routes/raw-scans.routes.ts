 ...
 * Stocke uniquement le scan brut - PAS DE PARSING
 * Les passagers/bagages arrivent via /passengers/sync et /baggage/sync (déjà parsés par mobile)
 */
router.post('/', requireAirportCode, async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        // ============================================
        // Sauvegarde du raw_scan UNIQUEMENT
        // Les passagers/bagages sont créés via /sync endpoints
        // ============================================
