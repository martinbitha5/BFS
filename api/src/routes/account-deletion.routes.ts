 ...
 */
router.post('/request-deletion', async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
router.get('/deletion-status/:email', async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
router.delete('/cancel-deletion/:email', async (req: Request & { userEmail?: string }, res: Response, next: NextFunction) => {
  try {
    const { email } = req.params;
